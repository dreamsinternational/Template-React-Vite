...
function Dashboard() {
    ...
    function handleSettings(){
        setsettingsShow(()=>{setsettingsShow(!settingsShow)})
        if(settingsShow){
            document.getElementById("theme-settings").className="settings-panel open"
            console.log(settingsShow)
            
        }
        else{
            document.getElementById("theme-settings").className="settings-panel "
            console.log(settingsShow)
            ...
            <div className="col-md-6 grid-margin stretch-card">
              <div className="card tale-bg">
                <div className="card-people mt-auto">
                  <img src="%PUBLIC_URL%/adminkit/images/dashboard/people.svg" alt="people"/>
...
<div className="container-scroller">
    ...
    <div className="container-fluid page-body-wrapper">
      <div className="theme-setting-wrapper">
        <button onClick={handleSettings} id="settings-trigger"><i className="ti-settings"></i></button>
        <div id="theme-settings" className="settings-panel">
          <button onClick={handleSettings} className="settings-close ti-close"></button>
